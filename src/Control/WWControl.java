...
import Run.Runner;
import Run.StatusChanger;
import WireWorldDisplay.MapButton;
import WireWorldDisplay.WWDisplay;
...
public class WWControl {
    ...
    /**
     * @return a WireWorldDisplay.MapButton-ket tároló JPanel-t adja vissza.
     * */
